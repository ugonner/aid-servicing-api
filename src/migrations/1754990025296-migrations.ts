...
export class Migrations1754990025296 implements MigrationInterface {
    name = 'Migrations1754990025296'

    public async up(queryRunner: QueryRunner): Promise<void> {
         await queryRunner.query(`
            ALTER TABLE \`profile_wallet\` DROP COLUMN \`balance\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`booking\`
            ADD \`bookingStatusNote\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`booking\`
            ADD \`virtualLocationAddress\` json NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`booking\`
            ADD \`isVirtualLocation\` tinyint NOT NULL DEFAULT 0
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service\`
            ADD \`virtualServiceRate\` int NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`virtualServiceEarnings\` int NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`noOfVirtualServices\` int NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\`
            ADD \`fundedBalance\` float(2) NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\`
            ADD \`earnedBalance\` float(2) NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\`
            ADD \`pendingBalance\` float(2) NOT NULL DEFAULT '0'
        `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\` DROP COLUMN \`pendingBalance\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\` DROP COLUMN \`earnedBalance\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\` DROP COLUMN \`fundedBalance\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`noOfVirtualServices\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`virtualServiceEarnings\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service\` DROP COLUMN \`virtualServiceRate\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`booking\` DROP COLUMN \`isVirtualLocation\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`booking\` DROP COLUMN \`virtualLocationAddress\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`booking\` DROP COLUMN \`bookingStatusNote\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`profile_wallet\`
            ADD \`balance\` float(12) NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
