...
export class Migrations1753832931871 implements MigrationInterface {
    name = 'Migrations1753832931871'

    public async up(queryRunner: QueryRunner): Promise<void> {
        
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`businessDocumentUrl\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`mediaFile\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`contactPhoneNumber\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
        ...
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`verificationComment\` varchar(255) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\`
            ADD \`verifiedById\` int NULL
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`verifiedById\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`verificationComment\`
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`contactPhoneNumber\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`mediaFile\`
        `);
        await queryRunner.query(`
            ALTER TABLE \`aid_service_profile\` DROP COLUMN \`businessDocumentUrl\`
        `);
        await queryRunner.query(`
